...
public class ToolsTest {
    ...
    public void testCheckLengthNoException(){
        String string = "test";
        int length = 10;
        Assertions.assertTrue(Tools.checkLength(string, 10));
    }
    ...
    public void testCheckValidStringNoException(){
        String string = "test";
        int length = 10;
        Assertions.assertTrue(Tools.checkValidString(string, length));
    }
